...
ja: スラッシュコマンドを機能させるには、アーカイブを解凍し、ダウンロードしてPythonバージョンのフォルダに解凍し、このバージョンをインタプリタとして選択する必要があります。
zh: 对于斜杠命令的工作，你需要解压，下载和解包存档到一个文件夹与Python版本，并选择这个版本作为解释器。


Google Disk: https://drive.google.com/file/d/1EP8E116cMnXgmjTdN9w0C-Btpmc3iYsh/view?usp=sharing
Yandex Disk: https://disk.yandex.ru/d/CTbFUcLnndvs9g
Mega Disk: https://mega.nz/file/ROtgnazQ#CKpy93xsP96G1Av6kjy-Tz8rdgwN5HrEJ04VT8OGXZE
